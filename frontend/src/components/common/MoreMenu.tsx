...
export default function MoreMenu({ isOpen, onClose }: MoreMenuProps) {
  ...
  return (
    <>
      ...
      {/* Menu Panel Wrapper - overflow hidden으로 탭바 위에서만 보이도록 */}
      <div className="fixed bottom-[68px] left-0 right-0 z-50 overflow-hidden sm:hidden">
        <div className="animate-slide-up rounded-t-2xl border-t bg-background pb-safe">
